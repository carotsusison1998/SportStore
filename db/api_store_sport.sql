...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2021 at 11:48 AM
...
(8, 'GUCCI', 'mô tả gucci', '2021-02-04 10:28:31'),
(9, 'VL', '<p>adasdasdasda dá dá</p>', '2021-02-04 10:40:07');
...
(56, 65, 'image_product-1612430293633.jpeg', 'uploads\\image_product-1612430293633.jpeg', '2021-02-04 09:18:13'),
(57, 65, 'image_product-1612430293635.jpeg', 'uploads\\image_product-1612430293635.jpeg', '2021-02-04 09:18:13');
...
(65, 6, 'Áo đấu câu lậc bộ arsenal', '155000', '115000', 50, 'image_product-1612430293633.jpeg', '<p>This is a very common but simple issue whenever i had also started working with docker multiple local containers.</p><p>See, you have created a node app and also a redis server, but both are separated, you didn\'t build any communication between them, that\'s why you are facing this type of problems.</p><p>Now, first you have to build a connection between the node app and redis-server so that they can communicate between then.</p><p>For doing this, just simply follow the instructions, hopefully this will solve your issues.</p><p>Step-1: For building connection between multiple local containers, you have two options to do this,This is a very common but simple issue whenever i had also started working with docker multiple local containers.</p><p>See, you have created a node app and also a redis server, but both are separated, you didn\'t build any communication between them, that\'s why you are facing this type of problems.</p><p>Now, first you have to build a connection between the node app and redis-server so that they can communicate between then.</p><p>For doing this, just simply follow the instructions, hopefully this will solve your issues.</p><p>Step-1: For building connection between multiple local containers, you have two options to do this,This is a very common but simple issue whenever i had also started working with docker multiple local containers.</p><p>See, you have created a node app and also a redis server, but both are separated, you didn\'t build any communication between them, that\'s why you are facing this type of problems.</p><p>Now, first you have to build a connection between the node app and redis-server so that they can communicate between then.</p><p>For doing this, just simply follow the instructions, hopefully this will solve your issues.</p><p>Step-1: For building connection between multiple local containers, you have two options to do this,This is a very common but simple issue whenever i had also started working with docker multiple local containers.</p><p>See, you have created a node app and also a redis server, but both are separated, you didn\'t build any communication between them, that\'s why you are facing this type of problems.</p><p>Now, first you have to build a connection between the node app and redis-server so that they can communicate between then.</p><p>For doing this, just simply follow the instructions, hopefully this will solve your issues.</p><p>Step-1: For building connection between multiple local containers, you have two options to do this,This is a very common but simple issue whenever i had also started working with docker multiple local containers.</p><p>See, you have created a node app and also a redis server, but both are separated, you didn\'t build any communication between them, that\'s why you are facing this type of problems.</p><p>Now, first you have to build a connection between the node app and redis-server so that they can communicate between then.</p><p>For doing this, just simply follow the instructions, hopefully this will solve your issues.</p><p>Step-1: For building connection between multiple local containers, you have two options to do this,</p>');
...
INSERT INTO `tbl_users` (`id`, `first_name`, `last_name`, `email`, `password`, `token`, `role`) VALUES
(2, 'Trần Ngọc', 'Lý', 'ly.tran@flex.com.vn', '$2b$10$4SGK0cecMXUzjXG0rtkZMeR2YZj3/aevVOkNoFqmZe4kwFQULf6hm', 'token', 1),
(4, 'Nguyễn Thị Tuyết', 'Nhi', 'nhi.nguyen@flex.com.vn', '$2b$10$F9gDDc/DwZ0CFEAQNNyuU.wO1TT9zwg1KX0NAqeydP7F6icoYg0MO', NULL, 1);
